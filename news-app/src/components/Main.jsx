    ...
    <div className={style.main}>
      <Router>
        <div className={style.header}>
          <div className={style.headerWrapper}>
            <div className={style.logoItem}>
              <Link className={style.logoText} to="./PageTopHeadlines">
                News
              </Link>
            </div>
            <ul className={style.routerNav}>
              <li className={style.routerNavItem}>
                <Link className={style.routerNavItemLink} to="./PageScience">
                  Science
                </Link>
              </li>
              <li className={style.routerNavItem}>
                <Link className={style.routerNavItemLink} to="./PageSport">
                  Sport
                </Link>
              </li>
              <li className={style.routerNavItem}>
                <Link className={style.routerNavItemLink} to="./PageHealth">
                  Health
                </Link>
              </li>
              <li className={style.routerNavItem}>
                <Link className={style.routerNavItemLink} to="./PageTechnology">
                  Technology
                </Link>
              </li>
            </ul>
        ...
        <Routes>
          <Route
            path="/"
            element={<Navigate replace to="/PageTopHeadlines" />}
          />
