  ...
  useEffect(() => {
    const getArticles = async () => {
      ...
      const res = await axios.get(
        `https://cors-anywhere.herokuapp.com/https://newsapi.org/v2/top-headlines?country=us&category=science&pageSize=80&apiKey=782a7379df92415ebe4dc42d9983fc99`
      );
